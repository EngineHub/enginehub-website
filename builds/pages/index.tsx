                                    ...
                                    >
                                        ...
                                        <td>
                                            ...
                                            <Link
                                                ...
                                                as={`/job/${projectEntry.project.id}/${encodeURIComponent(build.branch)}`}
                                                passHref={true}
                                            >
                                                <MainLink>
                                                    {build.branch}
                                        ...
                                        <td>
                                            <Link
                                                ...
                                                as={`/job/${projectEntry.project.id}/build/${build.build_id}`}
                                                passHref={true}
                                            >
                                                <MainLink>
                                                    #{build.build_number}
...
export async function getStaticProps() {
    ...
    return {
        props: {
            projectEntries: await getProjectEntries()
        },
        revalidate: 60
    };
}
